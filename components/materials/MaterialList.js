            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-green-600 font-medium">
                  Current Price: ${material.prices[0]?.price.toFixed(2) || '0.00'}
                </p>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="border border-gray-300 rounded-md px-3 py-1 w-24 focus:outline-none focus:ring-2 focus:ring-blue-500"
